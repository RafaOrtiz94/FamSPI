...
- `products_total`: 1672
- `products_with_cost_price`: 1441
- `products_with_expiry`: 1489
- `products_with_sale_price`: 1606
- `purchase_lines_total`: 9982
...
- `inventory_traceability`: OK
  ...
  faltantes: -
- `negotiations_budgeting`: OK
  instalados: crm, sale_crm
  faltantes: -
- `collaborators_hr`: OK
...
- `product_prices`: {"odoo_products_with_code": 1672, "source_sale_prices": 2740, "source_cost_prices": 1585, "sale_updated": 1606, "cost_updated": 1441, "sale_missing": 66, "cost_missing": 231}
...
- `partial_delivery`: {"outgoing_picking_types_configured": 1, "incoming_picking_types_configured": 1, "sale_orders_direct_policy": 0, "products_invoice_policy_delivery": 0, "products_lot_tracked_aligned": 1489}
- `partner_postprocess`: {"complete_name_fixed": 0, "commercial_partner_fixed": 0, "type_fixed": 0, "is_company_fixed": 0, "base_fields_fixed": 3659}
