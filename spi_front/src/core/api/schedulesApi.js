...
export const approveSchedule = (id) => api.post(`/schedules/${id}/approve`).then((res) => res.data?.data);
export const rejectSchedule = (id, reason) =>
  api.post(`/schedules/${id}/reject`, { reason }).then((res) => res.data?.data);
