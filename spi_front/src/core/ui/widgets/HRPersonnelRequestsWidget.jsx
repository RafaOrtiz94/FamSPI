...
import { formatDateSafe, formatDateTimeSafe } from '../../../shared/utils/dateUtils';
import {
    ...
    return (
        <>
            <Card className="p-6">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-7 gap-2 mb-4 text-xs">
                    <div className="bg-gray-50 rounded-lg px-3 py-2 text-center">
                        <p className="text-gray-500">Total</p>
                        <p className="text-sm font-semibold text-gray-900">{summary.total}</p>
                    </div>
                    <div className="bg-yellow-50 rounded-lg px-3 py-2 text-center">
                        <p className="text-yellow-700">Pendientes</p>
                        <p className="text-sm font-semibold text-yellow-800">{summary.pendiente}</p>
                    </div>
                    <div className="bg-blue-50 rounded-lg px-3 py-2 text-center">
                        <p className="text-blue-700">En revision</p>
                        <p className="text-sm font-semibold text-blue-800">{summary.en_revision}</p>
                    </div>
                    <div className="bg-green-50 rounded-lg px-3 py-2 text-center">
                        <p className="text-green-700">Aprobadas</p>
                        <p className="text-sm font-semibold text-green-800">{summary.aprobada}</p>
                    </div>
                    <div className="bg-red-50 rounded-lg px-3 py-2 text-center">
                        <p className="text-red-700">Rechazadas</p>
                        <p className="text-sm font-semibold text-red-800">{summary.rechazada}</p>
                    </div>
                    <div className="bg-purple-50 rounded-lg px-3 py-2 text-center">
                        <p className="text-purple-700">En proceso</p>
                        <p className="text-sm font-semibold text-purple-800">{summary.en_proceso}</p>
                    </div>
                    <div className="bg-gray-100 rounded-lg px-3 py-2 text-center">
                        <p className="text-gray-600">Completadas</p>
                        <p className="text-sm font-semibold text-gray-700">{summary.completada}</p>
                    </div>
                </div>
                ...
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
                    <div className="bg-white rounded-lg shadow-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
                        ...
                        <div className="px-6 py-6 space-y-6">
                            {/* Informacion General */}
                            <div>
                                <h3 className="text-lg font-semibold text-gray-900 mb-3">Informacion General</h3>
                                <div className="grid grid-cols-2 gap-4 text-sm">
                                    ...
                                    <div>
                                        <p className="text-gray-600">Tipo de Contratacion</p>
                            ...
                            <div>
                                ...
                                <div className="space-y-3 text-sm">
                                    <div>
                                        <p className="text-gray-600 font-medium">Nivel de Educacion</p>
                                    ...
                                    {selectedRequest.years_experience && (
                                        <div>
                                            <p className="text-gray-600 font-medium">Anios de Experiencia</p>
                                            <p>{selectedRequest.years_experience} anios</p>
                                        </div>
                                    )}
                                    {selectedRequest.specific_skills && (
                                        <div>
                                            <p className="text-gray-600 font-medium">Habilidades Especificas</p>
                                            <p className="whitespace-pre-wrap">{selectedRequest.specific_skills}</p>
                                        </div>
                                    )}
                                    {selectedRequest.technical_knowledge && (
                                        <div>
                                            <p className="text-gray-600 font-medium">Conocimientos Tecnicos</p>
                            ...
                            <div>
                                ...
                                <div className="space-y-3 text-sm">
                                    ...
                                    {selectedRequest.specific_functions && (
                                        <div>
                                            <p className="text-gray-600 font-medium">Funciones Especificas</p>
                            ...
                            {/* Justificacion */}
                            <div>
                                <h3 className="text-lg font-semibold text-gray-900 mb-3">Justificacion</h3>
                                    ...
                                    <div className="space-y-2">
                                        {selectedRequest.comments.map((c) => (
                                            <div key={c.id} className="bg-gray-50 rounded-lg p-3">
                                                ...
                                                <p className="text-xs text-gray-500 mt-1">
                                                    {formatDateTimeSafe(c.created_at)}
                                                </p>
                                            </div>
                                        ))}
                                    </div>
