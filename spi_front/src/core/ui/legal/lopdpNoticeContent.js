/**
 * Contenido legal del aviso de confidencialidad y tratamiento de datos LOPDP Ecuador
 * Para uso interno de FamSPI
 */
export const lopdpNoticeParagraphs = [
  ...
  "Reporta incidentes de seguridad o fugas de información inmediatamente al área de TICs/Talento Humano.",
...
export const lopdpNoticeTitle = "Acuerdo de Confidencialidad y Protección de Datos";
export const lopdpNoticeSubtitle = "LOPDP - Ecuador / Uso interno FamSPI";