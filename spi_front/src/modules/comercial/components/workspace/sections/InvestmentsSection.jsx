...
import { FiAlertTriangle, FiCheckCircle, FiClock, FiHardDrive, FiSave, FiSearch } from "react-icons/fi";
...
const EDIT_ROLES = new Set([
  ...
  "jefe_financiero", // 2026-09-23: rol completo abierto (antes solo alexandra.molina via EDIT_EXTRA_ROLE)
]);
...
// INVESTMENT_EDIT_EXTRA_ROLE en investmentEditAccess.js (backend).
...
const buildInvestmentBlocker = ({ permissions = {}, ownership = {}, requiresStatDocument, statDocumentUploaded, canEditRole }) => {
  ...
  if (!canEditRole) {
    return {
      ...
      message: "Solo ACP Comercial, Jefe Comercial, Jefe de Operaciones, Jefe de Servicio, Jefe de Logistica, Jefe de TI y Jefe Financiero pueden editar la lista.",
...
// adicionales. Solo jefe_ti (ver EDIT_ROLES y backend businessCase.routes.js).
// Cada activo vinculado queda reservado exclusivamente para este Business Case
// hasta que se libere (BC no factible) o se entregue el expediente de compras.
      ...
      <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3">
        <div>
          ...
          <p className="text-sm text-gray-500">
            ...
            Jefe de Logistica, Jefe de TI y Jefe Financiero pueden editarla en paralelo — la cantidad de cada item puede subir o bajar, incluido 0.
          </p>
          <div className="mt-2">
