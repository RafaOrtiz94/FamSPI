  ...
  return (
    <div className="bg-white border border-gray-200 rounded-xl p-4 shadow-sm">
      <div className="flex items-center justify-between mb-4">
        <div>
          <h3 className="text-lg font-semibold text-gray-900">Nueva solicitud de compra</h3>
          <p className="text-sm text-gray-500">Se enviará al ACP Comercial para gestionar proveedor</p>
        </div>
        <Button loading={creating} onClick={handleSubmit} disabled={loading || creating}>
          Enviar a ACP
        </Button>
      </div>
        ...
        <div>
          <label className="inline-flex items-center gap-2 text-sm font-medium text-gray-700">
            <input
              ...
              onChange={(e) => setForm((prev) => ({ ...prev, requiresLis: e.target.checked, lisOption: e.target.checked ? prev.lisOption : "" }))}
            />
