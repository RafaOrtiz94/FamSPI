...
export const CARGO_OPTIONS = [
  ...
  "RESPONSABLE TECNICO",
  "JEFE DE LOGISTICA",
  "JEFE DE OPERACIONES Y LOGISTICA",
  "JEFE DE FINANCIERO",
  ...
  "INGENIERO DE TICS",
  "AUXILIAR DE BODEGA Y TRANSPORTE",
  "ASESOR COMERCIAL",
  "AUXILIAR CONTABLE",
  "SUPPLY AND DEMAND PLANNING LEAD",
  "CUSTOMER LEAD",
];
...
export const EMPLOYEE_STATUS_OPTIONS = ["ACTIVO", "PASANTE", "PASIVO"];
...
export const profileSections = [
  {
    ...
    fields: [
      ...
      {
        key: "cedula",
        label: "NUMERO DE CEDULA O DNI",
        inputMode: "numeric",
        pattern: "[0-9]*",
        maxLength: 10,
        digitOnly: true,
        placeholder: "Cedula EC (10) o DNI PE (8)",
        helperText: "Acepta cedula ecuatoriana de 10 digitos o DNI peruano de 8 digitos.",
        required: true,
      },
      {
        key: "ruc",
      ...
      { key: "institucion_bancaria", label: "INSTITUCION BANCARIA" },
...
export const checklistSections = [
  {
    ...
    items: [
      ...
      {
        label: "Partida de nacimiento/cedula hijos (cuando aplique)",
        type: "doc",
