...
const CA0110AuthModal = ({ isOpen, onClose, onAuthenticated, actionLabel }) => {
    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/80 backdrop-blur-sm">
      <div className="relative w-[420px] rounded-2xl border border-red-500/20 bg-slate-950 p-8 shadow-[0_0_50px_rgba(239,68,68,0.15)]">
        ...
        <div className="mb-6 flex flex-col items-center">
          ...
          <p className="mt-1 text-center text-sm text-slate-400">Confirma tu identidad para {actionLabel || "aprobar el Gestion de Riesgos"}</p>
        </div>
...
export default CA0110AuthModal;