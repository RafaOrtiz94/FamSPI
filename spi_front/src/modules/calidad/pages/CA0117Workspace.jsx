...
export default function CA0117Workspace() {
  const [selectedLane, setSelectedLane] = useState(null);
  const lanes = [
    { key: "reports", title: "Reportes", desc: "Reportes de tecnovigilancia" },
    { key: "investigations", title: "Investigaciones", desc: "Investigaciones" },
    { key: "actions", title: "Acciones", desc: "Acciones correctivas" },
    { key: "notifications", title: "Notificaciones", desc: "Autoridades sanitarias" },
  ];
  ...
  return (
    <div className={WORKSPACE_PAGE_CLASS}>
      <header className="border-b border-gray-200 bg-white px-6 py-4">
        ...
        <p className="mt-1 text-sm text-gray-600">Sistema de tecnovigilancia GXP.</p>
      </header>
