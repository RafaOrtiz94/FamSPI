...
const laneCards = [
  ...
  { key: "recipients", title: "Destinatarios", description: "Destinatarios por rol", accent: "from-green-500 to-emerald-600", icon: FiUsers },
  { key: "attachments", title: "Adjuntos", description: "Archivos adjuntos", accent: "from-violet-500 to-purple-600", icon: FiFileText },
  { key: "templates", title: "Plantillas", description: "Templates de comunicación", accent: "from-orange-500 to-amber-600", icon: FiSend },
];

const summaryCards = [
  { title: "Flujos activos", value: "4", helper: "Comunicaciones, destinatarios, adjuntos, plantillas", icon: FiActivity },
  { title: "RBAC", value: "Privado", helper: "Rutas protegidas", icon: FiCheckCircle },
  { title: "Trazabilidad", value: "GXP", helper: "Workflow y SLAs listos", icon: FiActivity },
  { title: "Integración", value: "Comunicaciones", helper: "Gestión de comunicaciones", icon: FiMail },
];

export default function CA0113Workspace() {
  const { user } = useAuth();
