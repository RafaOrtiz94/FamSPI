                        ...
                        <div className="flex min-h-full items-center justify-center px-4 py-6 sm:px-6">
                            <Dialog.Panel className="w-full max-w-5xl">
                                <motion.div
                                    ...
                                    className="relative max-h-[90vh] overflow-y-auto rounded-2xl bg-white dark:bg-gray-900 shadow-2xl"
                                >
                                    {/* Header */}
                                    <div className="flex items-center justify-between p-6 border-b border-gray-200 sticky top-0 bg-white dark:bg-gray-900 z-10">
                                    ...
                                    {/* Footer */}
                                    <div className="flex gap-3 p-6 border-t border-gray-200 bg-gray-50 dark:bg-gray-900/60">
                                        <Button
                                            type="button"
                                            variant="secondary"
                                            onClick={handleClose}
