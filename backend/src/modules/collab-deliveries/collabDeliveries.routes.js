...
const { COLLAB_WRITE_ROLES, COLLAB_READ_ROLES } = require("./collabDeliveries.service");
...
router.post("/sessions",           requireRole(COLLAB_WRITE_ROLES), ctrl.createCollabSession);
