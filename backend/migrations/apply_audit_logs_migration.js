 ...
 * Applies Document Audit Logs migration (028)
 */
...
async function verifyTables() {
    logger.info('Verifying created tables and functions...');
...
async function main() {
    logger.info('🔐 Starting Document Audit Logs migration (Blockchain-like immutability)...');

    try {
        await applyMigration('028_document_audit_logs.sql');
