...
El modulo gestiona el ciclo de vida de colaboradores internos, la administracion de datos basicos, el perfil personal del usuario autenticado y la gestion de certificaciones con soporte documental y exportacion consolidada.
...
- Consulta individual y listados de usuarios.
- Actualizacion de rol, departamento y datos basicos.
- Eliminacion de usuario con limpieza de referencias.
- Consulta y actualizacion de perfil propio.
- Carga y validacion de avatar.
- Alta, consulta y baja logica de certificaciones.
- Carga masiva de certificaciones.
- Generacion de PDF consolidado de certificaciones.
