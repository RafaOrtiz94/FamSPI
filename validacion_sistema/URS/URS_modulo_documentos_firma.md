...
El modulo administra la evidencia documental de procesos internos, incluyendo documentos generados desde plantilla, adjuntos de solicitudes y firma digital avanzada con verificacion publica.
...
## Alcance funcional
- Crear documentos en base a plantillas.
- Firmar documentos (simple y avanzada).
- Exportar documentos a PDF.
- Gestionar archivos adjuntos por solicitud.
- Verificar autenticidad de documentos por token.
- Consultar trazabilidad y metricas de firma.
