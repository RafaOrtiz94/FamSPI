...
El modulo administra equipos y unidades de inventario para procesos internos de compra, entrega y servicio tecnico, incluyendo catalogo de modelos, serializacion, asignacion a clientes, cambios de estado y registro de movimientos.
...
- Consulta de equipos disponibles por filtros.
- Consulta de equipos por cliente.
- Consulta de modelos de equipos.
- Creacion de unidades desde modelo.
- Registro o confirmacion de serial por unidad.
...
- Clientes.
- Pedidos/Solicitudes.
- Facturacion (movimientos e impacto de stock).
